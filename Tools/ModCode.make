#-------------------------------------------------------------------------------
#
#   Generic Mod Makefile for one version of a multi-version set - MC 1.7
#
#-------------------------------------------------------------------------------
...
SRC_INCLUDE := build.gradle gradle.properties Makefile README.html $(SRCDIRS) src/resources Tools
...
lang:
	@if [ -e src/$(MODNAME).names ]; then \
		...
		Tools/genlang $(MODNAME) $(LANGKEY) src/$(MODNAME).names; \
	fi

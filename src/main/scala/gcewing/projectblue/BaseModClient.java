...
import gcewing.projectblue.BaseMod.IBlock;
import gcewing.projectblue.BaseMod.VSBinding;
...
public class BaseModClient<MOD extends BaseMod<? extends BaseModClient>> implements IGuiHandler {
            ...
            while (cls == null) {
                try {
                    ...
                    if (i < 0) throw new RuntimeException(
                            String.format(
                                    "Block renderer class %s not found in %s or containing packages",
                                    clsName,
                                    initPkgName));
    ...
    public Object getClientGuiElement(int id, EntityPlayer player, World world, int x, int y, int z) {
        ...
        if (scrnCls != null) {
            ...
            if (result == null) result = base.createGuiElement(scrnCls, player, world, x, y, z, param);
        } else {

...
public abstract class PBFacePart extends JCuboidFacePart {
    ...
    public static class FaceItem extends ItemMultiPartJ {
        ...
        public static void registerRenderers(BaseModClient client) {
            for (FaceItem item : instances) client.addItemRenderer(item, new ItemRenderer(item));
        }
        ...
        @Override
        public PBFacePart newPart(ItemStack stack, EntityPlayer player, World world, BlockCoord pos, int sideHit,
                codechicken.lib.vec.Vector3 vhit) {
            int side = sideHit ^ 1;

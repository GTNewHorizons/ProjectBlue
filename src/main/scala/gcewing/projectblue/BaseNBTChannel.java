...
public class BaseNBTChannel<PACKET_TYPE extends Enum> {
    ...
    void sendToTarget(PACKET_TYPE type, NBTTagCompound nbt, Side fromSide, FMLOutboundHandler.OutboundTarget target,
            Object... args) {
        ...
        if (args.length == 1) chan.attr(FMLOutboundHandler.FML_MESSAGETARGETARGS).set(args[0]);
    ...
    static class NBTCodec<PACKET_TYPE extends Enum> extends FMLIndexedMessageToMessageCodec<NBTMessage<PACKET_TYPE>> {
        ...
        @Override
        public void encodeInto(ChannelHandlerContext ctx, NBTMessage<PACKET_TYPE> msg, ByteBuf target)
                throws Exception {

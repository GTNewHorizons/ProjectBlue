...
public class SprayCanItem extends Item {
    ...
    public int getColor(ItemStack stack) {
        ...
        if (nbt != null) return nbt.getInteger("color");
        return 0;
    }
    ...
    public void registerIcons(IIconRegister reg) {
        ...
        for (int i = 0; i <= 16; i++) icons[i] = reg.registerIcon(String.format("%s-%d", prefix, i));
    }
    ...
    public void getSubItems(Item item, CreativeTabs tab, List result) {
        for (int i = 0; i <= 16; i++) result.add(this.newStack(1, i));
    }
    ...
    public ItemStack getContainerItem(ItemStack stack) {
        ...
        } else result = new ItemStack(ProjectBlue.emptySprayCan);
        return result;
    }

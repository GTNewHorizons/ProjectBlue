...
public class BaseMod<CLIENT extends BaseModClient<? extends BaseMod>> extends BaseIntegration implements IGuiHandler {
    ...
    public void init(FMLInitializationEvent e) {
        ...
        for (BaseIntegration i : integrations) if (i != this) i.init(e);
    }

    public void postInit(FMLPostInitializationEvent e) {
        for (BaseIntegration i : integrations) {
            if (i != this) i.postInit(e);
            i.registerRecipes();
    ...
    public Object getServerGuiElement(int id, EntityPlayer player, World world, int x, int y, int z) {
        ...
        Object result;
        if (cls != null) result = createGuiElement(cls, player, world, x, y, z, param);
        else result = getGuiContainer(id, player, world, x, y, z, param);
    ...
    Object createGuiElement(Class cls, EntityPlayer player, World world, int x, int y, int z, int param) {
        try {
            ...
            Method m = getMethod(
                    ...
                    int.class,
                    int.class);
            if (m != null) return m.invoke(null, player, world, x, y, z, param);
            m = getMethod(cls, "create", EntityPlayer.class, World.class, int.class, int.class, int.class);
            if (m != null) return m.invoke(null, player, world, x, y, z);
            ...
            Constructor c = getConstructor(
                    ...
                    int.class,
                    int.class);
            if (c != null) return c.newInstance(player, world, x, y, z, param);
            c = getConstructor(cls, EntityPlayer.class, World.class, int.class, int.class, int.class);
            if (c != null) return c.newInstance(player, world, x, y, z);
